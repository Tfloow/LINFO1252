...
PROGRAM=( "philosopher_home" "reader-writer_home" "prod-cons_home" ) # "philosopher" "reader-writer" "prod-cons" "test-and-set" "test-test-and-set" "philosopher_home" "reader-writer_home" "prod-cons_home" ) #  "test-test-and-set" "test-and-set" ) # "prod-cons" "philosopher" "reader-writer" "test-and-set" "test-test-and-set" ) #"test-and-set" "test-test-and-set" # the program we handle right now
