...
PROGRAM=( "prod-cons_home" "reader-writer_home" "philosopher_home" ) # "test-and-set" "test-test-and-set" "philosopher_home" "prod-cons_home" ) # "prod-cons" "philosopher" "reader-writer" "test-and-set" "test-test-and-set" ) #"test-and-set" "test-test-and-set" # the program we handle right now
