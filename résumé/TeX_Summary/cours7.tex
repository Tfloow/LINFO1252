...
\DataTypeTok{int}\NormalTok{ sem\_init}\OperatorTok{(}\NormalTok{sem\_t }\OperatorTok{*}\NormalTok{sem}\OperatorTok{,} \DataTypeTok{int}\NormalTok{ pshared}\OperatorTok{,} \DataTypeTok{unsigned} \DataTypeTok{int}\NormalTok{ value}\OperatorTok{);} \CommentTok{// initialise avec value le nombre }
\CommentTok{//de place      pshared = 0}
